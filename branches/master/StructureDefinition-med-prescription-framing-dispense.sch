...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'med-prescription-framing-type']) &lt;= 1">extension with URL = 'med-prescription-framing-type': maximum cardinality of 'extension' is 1</sch:assert>
